            ...
            return(
                <div className="projects-grid">
                    ...
                    <Card shadow={5} className="project-card">
                        <CardTitle style={{color: '#fff', fontSize: 'bold', height: '176px', background: 'url(https://www.freecodecamp.org/news/content/images/size/w2000/2020/02/Ekran-Resmi-2019-11-18-18.08.13.png) center / cover'}}></CardTitle>
                        <CardText style={{wordWrap: 'break-all', justifyContent: 'space-evenly', textAlign: 'justify'}}>
                            A browser-based coding environment that is run by a CLI - JSX Editor.<br />Used the WASM EsBuild plugin to make a custom plugin which will compile and execute JSX code on the fly.<br />A production level application done completely with Typescript and a basic Express application for the backend. Used the Monaco editor for a full functional code editor. The code cells and the markdown cells persist the data entered that is saved for every next session.<br />Installed on the users computer by running a CLI command - 'npx jsx-editor serve' or 'npm i -g jsx-editor serve'.
                        </CardText>
                        <CardActions border style={{justifyContent: 'space-between', display: 'flex'}}>
