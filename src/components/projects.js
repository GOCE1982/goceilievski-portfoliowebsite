        ...
        if(this.state.activeTab === 0){
            return(
                <div className="projects-grid">
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                        ...
                        <CardText>
                            The very fist project I finished while learning ReactJS. It covers the very basics, plus using the Redux framework for state management. Heavily utilized the Twitter Bootstrap framework for the front-end. Used JSON placeholder for mocking the back-end and deployed it to a free Netlify hosting.
                        </CardText>
                        <CardActions border>
                    ...
                    <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                        <CardTitle style={{color: '#fff', fontSize: 'bold', height: '176px', background: 'url(https://www.freecodecamp.org/news/content/images/size/w2000/2020/02/Ekran-Resmi-2019-11-18-18.08.13.png) center / cover'}}></CardTitle>
                        <CardText>
                            The second React project - a client manager. Using Firebase with enabled authentication throught react-redux-firebase. Production level application with real usable features and persistance of the data in the cloud database.
                        </CardText>
                        <CardActions border>
            ...
            return(
                ...
                <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                    ...
                    <CardText>
                        The fist project I finished while learning web development with NodeJS. Used the Express framework with the EJS templating language, implemented user authentication with PassportJS and a backend REST API with full CRUD functionality.
                    </CardText>
                    <CardActions border>
